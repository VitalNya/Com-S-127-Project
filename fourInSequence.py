# <Vital Nyabashi>             <04/30/2023>
# <Assignment 5/ Lab A/>
# <Make a connect 4 game! Computer will take in an input from the user(s). If the user decides to play a one player game,
# they play against an AI, and if they choose two player game they play against two players. User(s) will be asked where
# they would like tp place their move, and fist to have two of their markers in a row wins!.>
            ...
            while True:
                ...
                if numPlayers == 1:
                    if currentPlayerTurn == 1:
                        ...
                        print(
                            "ERROR: currentPlayerTurn is neither 1 or 2! It is actually: {0}".format(currentPlayerTurn))
                        sys.exit()
                elif numPlayers == 2:
                    col = getHumanInput(board, currentPlayerTurn)
                else:
                ...
                if winner == True:
                    ...
                    print("~~ End Of Player {0} ({1}) Turn ~~".format(currentPlayerTurn,
                                                                      getPlayerPiece(currentPlayerTurn)))
                    print()
                # switch turns
                currentPlayerTurn = switchTurns(currentPlayerTurn)

        elif choice == "i":
            # Print out the instructions/ algorithm for the game.
            print("This is a connect four game. The player will be asked to choose whether they want to play against "),
            print(
                "players or against an AI. The player(s) will be asked where they want to place their mark." "You will play,")
            print(
                "the game till you or the opponent has 4 plays that connect either vertically, horizontally, or diagonally")
            print("Good luck and enjoy the game")
            print()
            # (KEEP this TODO line when completed) (1 pt.)

        elif choice == "q":
            # Set the 'running' variable to False, and print out a 'Goodbye!' message to the player.
            running = False
            print("Goodbye")
            # (KEEP this TODO line when completed) (1 pt.)
